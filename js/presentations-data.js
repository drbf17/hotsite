window.PRESENTATIONS = [
  ...
  // 1. Crie o diretório presentations/<slug>/ com seu próprio index.html, css/, js/ e assets/ (bundle independente).
  // 2. Adicione um objeto { slug, title, description, href } aqui.
];
